        ...
        fields = {
            ...
            2: {   # data
                ...
                9: {    # field9 - player details
                    1: "[C][B][FF0000] BRUTAL CHEATS",  # Nickname
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]OWNER: [FFFFFF]PARKHAI [00FF00]!!
"""
...
"""
        ...
        # Use ThreadPoolExecutor to avoid blocking the async loop
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][FF0000]╔══════════╗
[FFFFFF]✨ OWNER BRUTAL ABHISHEK   
[FFFFFF]            
[FFFFFF]                   THANKS FOR SUPPORTING ᴘᴀʀᴋʜᴀɪｘʙᴏᴛ
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF] PARKHAI    
[FFD700]✨ BOT NAME [FFFFFF] ᴘᴀʀᴋʜᴀɪｘʙᴏᴛ
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> BRUTAL ABHISHEK ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "PARKHAI", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}𝙷𝙴𝚈 𝚄𝚂𝙴𝚁𝚂 𝚆𝙴𝙻𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ᴘᴀʀᴋʜᴀɪｘʙᴏᴛ"
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493] BRUTAL ABHISHEK 
...
async def MaiiiinE():
    Uid , Pw = '4400397863','CAB66339DDFB09BF9D14C3D7413DBC486719CEB222D40131667F7EE8A8931906'
    ...
    os.system('clear')
    print("Initializing PARKHAI BOT...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    os.system('clear')
    print(render('PARKHSI', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 PARKHAI BOT - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: PARKHAI {acc_name}")
    print(f"🔹 Status: 🟢 READY")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using PARKHAI BOT")
    sys.exit(0)
